          ...
          <div class="panel-group" id="musicStore">
                  ...
                  <div class="row">
                    ...
                    <div class="col-md-3 album-cover">
                      <div class="col-md-12 thumbnail">
                        <img class=""
                          src="https://d37djvu3ytnwxt.cloudfront.net/assets/courseware/v1/3b2b44f45d3e95384a8638f57c3805ef/asset-v1:Microsoft+DEV203x+2T2017+type@asset+block/Album.gif"
                          alt="Album cover">
                        <br>
                    ...
                    <div class="col-md-9">
                      <form class="form form-horizontal" action="" method=" post">
                        ...
                        <div class="form-group">
                          ...
                          <div class="col-sm-10">
                            <input type="text" id="studioInfo" class="form-control" value="">
                          </div>
                        </div>
                        ...
                        <div class="form-group">
                          ...
                          <div class="col-sm-10">
                            <textarea name="name" id="desc" rows="5" class="form-control"value="" ></textarea>
                          </div>
                        </div>
                      </form>
                    </div>
            ...
            <div class="row">
              <input type="submit" class="btn btn-success col-sm-4 col-sm-offset-4" data-toggle="modal"
                data-target="#submitWindow" value="Submit">
            </div>
            ...
            <div class="modal fade" id="submitWindow" tabindex="-1" role="dialog" aria-hidden="true">
              <div class="modal-dialog">
                <div class="modal-content">
                  <!-- Modal Header -->
                  <div class="modal-header">
                    <h3 class="modal-title text-center">Are you shure?</h4>
                  </div>
                  <!-- Modal Body -->
                  <div class="modal-body">
                  ...
                  <!--  Modal footer-->
                  <div class="modal-footer">
                    <button type="button" class="btn btn-warning" data-dismiss="modal">Cansel</button>
